# se_agent/tools/generate_capella_fabric.py
...
@register_tool
class GenerateCapellaFabricTool(TransformTool):
    """
    ...
    # ===============================
    TOOL_NAME = "generate_capella_fabric"
    DESCRIPTION = (
    ...
    IO_SCHEMA = {
        ...
        "outputs": {
            "fabric_artifact_id": {"type": "capella_fabric",
            "remember": False,
    ...
    def transform(self, input_data, artifacts, package_name=None):
        ...
        try:
            ...
            capella_fabric = yaml_handler.get_yaml_content()
        except Exception as e:
        ...
        return capella_fabric, metadata
    ...
    def run(self, input_data, artifacts, package_name=None, **_):
        ...
        capella_fabric, metadata = self.transform(input_data, artifacts, package_name)
